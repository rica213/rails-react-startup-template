...
**Hello Rails React** is a startup project for Rails as a backend and React as frontend. <br> It uses Redux to manage the state and Postgresql for database.
...
| Frontend | <a href="#">React</a> |
| State Management | <a href="#">Redux</a> |
...
```sh
  cd my-folder
  git clone git@github.com:rica213/hello-rails-react.git
```
